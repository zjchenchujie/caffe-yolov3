import sys
# sys.path.append('/home/chujie/git_chujie/yolov3-caffe/caffe_latest/python')
sys.path.append('/home/chujie/git_chujie/caffe_master_yolov3_dx/python')
import caffe
import numpy as np
...
def cfg2prototxt(cfgfile):
    ...
    for block in blocks:
        if block['type'] == 'net':
            ...
            if block['pad'] == '1':
                convolution_param['pad'] = str(int((int(convolution_param['kernel_size'])-1)/2))
            ...
            for i in range(bottom_layer_size):
                r_lyer = int(layer_name[i])
                prev_layer_id = (r_lyer+1) if r_lyer > 0 else (layer_id+r_lyer)
                bottom = topnames[prev_layer_id]
                route_layer['bottom'].append(bottom)
...
#    caffemodel = sys.argv[4]
    ...
    cfgfile = '/home/chujie/git_chujie/obj_det_sample/cfg/det_10.cfg'
    weightfile = '/home/chujie/git_chujie/obj_det_sample/cfg/det_10.weights'
    protofile = './result/caffe_model/det_10.prototxt'
    caffemodel = './result/caffe_model/det_10.caffemodel'
